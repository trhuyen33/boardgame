        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h4 class="m-0 font-weight-bold text-primary d-inline"><?php echo (isset($_REQUEST['code']) ? "Sửa loại sản phẩm " . $code : "Thêm loại sản phẩm") ?></h4>
            </div>
            <form class="card-body" id="type-form">
              <div class="form-row">
                ...
                <div class="form-group col-md-12">
                  ...
                  <?php
                  if (isset($_REQUEST['code'])) {
                    echo "<input type=\"button\" value=\"Xóa loại sản phẩm\" class=\"btn bg-danger text-white\" onclick=\"deleteType('".$code."')\"></input>";
                  }
                  ?>
                </div>
              </div>
