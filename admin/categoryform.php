        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h4 class="m-0 font-weight-bold text-primary d-inline"><?php echo (isset($_REQUEST['code']) ? "Sửa thể loại " . $code : "Thêm thể loại") ?></h4>
            </div>
            <form class="card-body" id="category-form">
              <div class="form-row">
